...
public class ClientFrame extends JFrame implements ActionListener, ISocketListener {
	...
	public ClientFrame() {
		...
		disconnectButton.setBounds(175, 80, 150, 25);
		...
		searchLabel.setBounds(475, 10, 75, 25);
		searchInput.setBounds(560, 10, 200, 25);
		searchButton.setBounds(810, 10, 150, 25);
		getContentPane().add(searchButton);
		getContentPane().add(searchInput);
		getContentPane().add(searchLabel);
		JScrollPane listScrollPane = new JScrollPane();
		listScrollPane.setBounds(10, 135, 950, 350);
